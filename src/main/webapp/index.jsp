...
<div class="container">
    <div class="row">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<%=request.getContextPath()%>/login.jsp">Log in</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="card" style="width: 100%">
            ...
            <div class="card-body">
                <table class="table">
                    <tbody>
                    <% for (Post post : DbStore.instOf().findAllPostsToday()) { %>
                    <tr>
                        <td>
                            <%=post.getName()%>
                        </td>
    ...
    <div class="row pt-3">
        <div class="card" style="width: 100%">
            ...
            <div class="card-body">
                <table class="table">
                    <tbody>
                    <% for (Candidate candidate : DbStore.instOf().findAllCandidatesToday()) { %>
                    <tr>
                        <td>
                            <%=candidate.getName()%>
                        </td>
